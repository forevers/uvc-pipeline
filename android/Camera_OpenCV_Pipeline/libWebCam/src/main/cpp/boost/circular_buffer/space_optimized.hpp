...
// Typedefs
    ...
    //typedef typename csi_circular_buffer<T, Alloc>::return_value_type return_value_type;
...
// Inherited
    ...
    reference operator [] (size_type n) { return csi_circular_buffer<T, Alloc>::operator[](n); }
    const_reference operator [] (size_type n) const { return csi_circular_buffer<T, Alloc>::operator[](n); }
#else
...
// Overridden
    ...
    */
    size_type internal_capacity() const BOOST_NOEXCEPT { return csi_circular_buffer<T, Alloc>::capacity(); }
